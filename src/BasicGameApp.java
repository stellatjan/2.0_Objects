   ...
   // Initialize your variables and construct your program objects here.
	public BasicGameApp() {
      ...
      //create (construct) the objects needed for the game and load up
		background = Toolkit.getDefaultToolkit().getImage("catcrocbackground.png");
		astroPic = Toolkit.getDefaultToolkit().getImage("croc image cs.png"); //load the picture
		atlasPic = Toolkit.getDefaultToolkit().getImage("croc image cs.png");
		astro = new Astronaut(100,300);
		atlas = new Astronaut(100,100);
